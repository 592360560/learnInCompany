...
//    RabbitAdmin rabbitAdmin;
    ...
    @Bean
    public FanoutExchange fanoutExchange() { // 使用直连的模式
...
//        Binding to = BindingBuilder.bind(firstQueue()).to(fanoutExchange();
//        return
//    }
    ...
    public Queue fanoutQueue1(){
        return new Queue(FANOUT_QUEUE_NAME1,true,false,false,null);
    }
    @Bean("fanoutQueue2")
    public Queue fanoutQueue2(){
        return new Queue(FANOUT_QUEUE_NAME2,true,false,false,null);
    }
